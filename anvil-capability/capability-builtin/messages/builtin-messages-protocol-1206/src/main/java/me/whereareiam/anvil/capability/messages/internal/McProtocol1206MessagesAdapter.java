 ...
 */
public final class McProtocol1206MessagesAdapter implements ProtocolCapabilityAdapter {
	...
	public boolean supports(int protocolNumber) {
		return McProtocol1206MessagesAdapterProvider.supportsProtocol(protocolNumber);
	}
