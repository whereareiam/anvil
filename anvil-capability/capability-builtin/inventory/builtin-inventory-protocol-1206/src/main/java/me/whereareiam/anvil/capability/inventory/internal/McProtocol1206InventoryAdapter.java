 ...
 */
public final class McProtocol1206InventoryAdapter implements ProtocolCapabilityAdapter {
	@Override
	...
	public boolean supports(int protocolNumber) {
		return McProtocol1206InventoryAdapterProvider.supportsProtocol(protocolNumber);
	}
