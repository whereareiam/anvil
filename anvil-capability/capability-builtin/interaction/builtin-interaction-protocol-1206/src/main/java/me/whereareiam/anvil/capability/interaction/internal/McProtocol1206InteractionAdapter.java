 ...
 */
public final class McProtocol1206InteractionAdapter implements ProtocolCapabilityAdapter {
	@Override
	...
	public boolean supports(int protocolNumber) {
		return McProtocol1206InteractionAdapterProvider.supportsProtocol(protocolNumber);
	}
