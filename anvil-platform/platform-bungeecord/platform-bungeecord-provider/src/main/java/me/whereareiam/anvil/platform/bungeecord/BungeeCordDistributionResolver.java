...
final class BungeeCordDistributionResolver {
	ResolvedDistribution resolve(MinecraftProxy proxy, PlatformContext context) throws IOException {
		...
		Path jar = context.getArtifactResolver().obtain(uri, destination, distribution.getSha256());
