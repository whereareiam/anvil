...
import me.whereareiam.anvil.execution.docker.process.DockerProcessTarget;
import me.whereareiam.anvil.execution.docker.DockerContainerFactory;
import me.whereareiam.anvil.execution.docker.image.DockerImageResolver;
...
final class DockerExecutionSession implements ExecutionSession {
    ...
    public @NotNull ProcessTarget prepare(@NotNull ProcessRequest request) {
        ...
        String image = images.resolve(request.getJavaRequirement(), request.getMinimumJavaVersion());
