---
title: Artifacts
description: Reuse downloaded software and metadata and configure acquisition for offline runs.
---

Anvil retains acquired software so repeated runs can reuse their inputs. Configure its location
through the [cache overview](../index.md), and keep the same root when preparing and later running
...
Offline mode does not disable [snapshot](../snapshots/index.md) restores or saves; those use the
selected workspace cache policy.
