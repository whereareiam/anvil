...
class AnvilScenariosPlugin : Plugin<Project> {
    override fun apply(project: Project) {
        ...
        val scenarioRunnerTask = project.tasks.register(
            ...
            parallelism.set(capability.parallelism)
            startupMemoryMegabytes.set(capability.startupMemoryMegabytes)
            downloadParallelism.set(capability.downloadParallelism)
